...
- Done several projects using Java, DataStructures, HTML, CSS, PHP, famous Algorithms, and some encryption! 
- Interested in Android development, and UX/UI.
- Currently backend development with Springboot to make some API's !
